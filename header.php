    	...
    	<div class="container">
            ...
            <div class="navbar-collapse collapse">
            	<ul class="nav navbar-nav">
                    ...
                    <li class="dropdown menu-large">
                    	<a href="#" class="dropdown-toggle" data-toggle="dropdown">ISLAMIC GADGETS <!-- <b class="caret"></b> --></a>
                        <ul class="dropdown-menu megamenu row">
                        	<li class="col-sm-3">
                            	<ul>
                                	<li class="dropdown-header">Glyphicons</li>
                    ...
                    <li class="dropdown menu-large">
                    	<a href="#" class="dropdown-toggle" data-toggle="dropdown">ISLAMIC E-BOOKS <!-- <b class="caret"></b> --></a>
                        <ul class="dropdown-menu megamenu row">
                        	<li class="col-sm-3">
                            	<ul>
                                	<li class="dropdown-header">Glyphicons</li>
